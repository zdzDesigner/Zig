...
pub const Font = struct {
    ...
    pub fn renderUtf8Solid(self: Font, text: [:0]const u8, foreground: sdl.Color) !sdl.Surface {
        return sdl.Surface{
            .ptr = sdl.c.TTF_RenderUTF8_Solid(
                self.ptr,
                text.ptr,
                .{ .r = foreground.r, .g = foreground.g, .b = foreground.b, .a = foreground.a },
            ) orelse return makeError(),
    ...
    pub fn renderUnicodESolid(self: Font, text: [:0]const u8, foreground: sdl.Color) !sdl.Surface {
        return sdl.Surface{
            .ptr = sdl.c.TTF_RenderUNICODE_Solid(
                self.ptr,
                text.ptr,
                .{ .r = foreground.r, .g = foreground.g, .b = foreground.b, .a = foreground.a },
            ) orelse return makeError(),
