...
pub extern fn TTF_RenderUTF8_Solid(font: *TTF_Font, text: [*c]const u8, fg: sdl.SDL_Color) ?*sdl.SDL_Surface;

pub extern fn TTF_RenderUNICODE_Solid(font: *TTF_Font, text: [*c]const u16, fg: sdl.SDL_Color) ?*sdl.SDL_Surface;
